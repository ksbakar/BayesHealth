...
<form id="contactForm">
  ...
  <button type="submit" style="padding:10px 20px; background-color:#1f4e79; color:white; border:none; border-radius:6px; cursor:pointer;">
    Submit
  </button>
</form>
...
<script>
const endpoint = "https://script.google.com/macros/s/AKfycbxzmgw2JS9xGJlviZSBP5-37dHDwx6TaL0Ch-Oi5UfQUWzOfliNFR_CAIAWJk1HCB7R/exec";
